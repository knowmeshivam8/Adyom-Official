...
import {
    ...
    Calendar, Star, Search, Filter, ChevronDown, Video, Clock
} from 'lucide-react';
...
export default function Programs() {
    ...
    return (
        <div className="overflow-hidden">
            ...
            {/* Filters */}
            <section className="py-8 bg-heritage-terracottaBg sticky top-[calc(4rem+1px)] md:top-[calc(5rem+1px)] z-30 shadow-sm">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        <div className="relative flex-1 max-w-md">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 rounded-md border border-heritage-terracottaDark/30 bg-heritage-terracottaBg text-sm font-body text-heritage-brown placeholder:text-heritage-sand focus:ring-2 focus:ring-heritage-gold focus:outline-none"
                            />
                        </div>
