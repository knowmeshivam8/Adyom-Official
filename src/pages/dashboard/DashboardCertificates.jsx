...
import {
    ...
    ChevronRight, ExternalLink, Printer, Mail,
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className="bg-surface rounded-xl shadow-md border border-heritage-creamDark p-5 flex flex-col md:flex-row md:items-center gap-4">
